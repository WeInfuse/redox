  ...
  describe 'patient' do
    ...
    describe 'contacts' do
      ...
      it 'can be converted from an array of hashes to Contact objects using method' do
        ...
        assert_kind_of(Redox::Models::Contact, p.contacts.first)
      end
    end
    ...
    describe 'insurances' do
      ...
      it 'can be converted using method' do
        ...
        assert_kind_of(Redox::Models::Insurance, p.insurances.first)
      end
    end
    ...
    describe 'redox calls' do
      before do
        stub_request(:post, /#{Redox::Authentication::BASE_ENDPOINT}/o)
          ...
          .to_return(status: 200, body: { accessToken: 'let.me.in',
                                          expires: (Time.now + 60).utc.strftime(Redox::Models::Meta::TO_DATETIME_FORMAT), refreshToken: 'rtoken' }.to_json)
